            ...
            <div class="container">
                <div class="container" style="background-color:	#e0e5e5">
                    ...
                    <div class="container2" style="background-color:white">
                        <p> We’re committed to ensuring that your privacy is protected and strictly follow the General
                            Data
                                ...
                                <div class="container3" style="background-color:white">
                                    <fieldset>
                                        <label><input type="checkbox" required name="privacy_policy"
                                                      id="privacy_policy" class="form-radio"
                                                      value="<?php echo $_POST['privacy_policy']; ?>"/>Check
                                            here
