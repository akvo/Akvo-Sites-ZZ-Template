        ...
        <div class="wrap">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Privacy policy and terms</h3>
                </div>
                        ...
                        <div class="form-group">
                            <fieldset>
                                <label><input type="checkbox" required name="privacy_policy"
                                              id="privacy_policy" value="<?php echo $_POST['privacy_policy']; ?>"/>Check
                                    here
...
{ ?><label> Here you read the <a href = "<?php echo site_url('/akvo-general-privacy-policy') ?>">privacy policy and terms </a>of Akvo Foundation.</label >
    <?php
}
...
/**remove privacy policy from the settings menu, only the terms are accepted by the user
...
$privacy_policy = get_user_meta($current_user, 'privacy_policy', true);
if ($privacy_policy) {
remove_submenu_page('options-general.php', 'options_page_slug');
