                  ...
                  <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 no-padding bhoechie-tab-menu">
                     <div class="list-group">
                        <a id="1" href="#" class="list-group-item active text-left" onclick="show_upload(this.id);">
                           ...
                           <?php echo esc_html__('Upload from Desktop','wp-advanced-importer');?>
                        </a>
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 no-padding bhoechie-tab">
                     <div id ='displaysection' class="col-md-12" style='display: none;'>
                        ...
                        <div class="form-group mt10">
                           ...
                           <label class="pl20">
                           <input disabled type="radio" name="import_mode" id="" value="existing_items"> <?php echo esc_html__('Existing Items','wp-advanced-importer');?>
                           </label>
                        </div>
                        <div id="select_module" class="select_module col-md-8 col-md-offset-3">
                           <span>
                           <label class="import-textnew"><?php echo esc_html__('Import each record as','wp-advanced-importer');?></label>
                           </span>
                     ...
                     <div class="bhoechie-tab-content active" id="division1">
                        <div class="file_upload">
                           ...
                           <span id="fileupload" style="cursor: pointer;" class="import-icon"> <img src="<?php echo plugins_url().'/'.XML_SM_UCI_SLUG ;?>/assets/images/upload-128.png" width="60" height="60" /> </span>
                        ...
                        <div class="col-md-12" >
                           <div class="col-md-6 col-sm-6">
                              <div class="wp_csv_ftp form-group">
                                 <label><?php echo esc_html__('Hostname','wp-advanced-importer');?></label>
                                 <input type="text" name="host_name" id="host_name" class="align form-control textbox_size" value="" >
                                 <p class="hint_fonts"><?php echo esc_html__('smackcoders.com or 54.213.74.129','wp-advanced-importer');?></p>
                              </div>
                              <div class="wp_csv_ftp form-group">
                                 <label><?php echo esc_html__('Host Username','wp-advanced-importer');?></label>
                                 <input type="text" name="host_username" id="host_username" class="align form-control textbox_size" value =""  >
                                 <p class="hint_fonts" ><?php echo __('ftp username','wp-advanced-importer');?></p>
                              </div>
                           </div>
                           <div class="col-md-6 col-sm-6">
                              <div class="wp_csv_ftp form-group">
                                 <label><?php echo esc_html__('Host Port','wp-advanced-importer');?></label>
                                 <input type="text" name="host_port" id="host_port" class="align form-control textbox_size" value=""  >
                                 <p class="hint_fonts"><?php echo esc_html__('Default Port : 21','wp-advanced-importer');?></p>
                              </div>
                              <div class="wp_csv_ftp form-group">
                                 <label><?php echo esc_html__('Host Password','wp-advanced-importer');?></label>
                                 <input type="text" name="host_password" id="host_password" class="align form-control textbox_size" value="" > 
                                 <p class="hint_fonts"><?php echo esc_html__('ftp password','wp-advanced-importer');?></p>
                              </div>
                           </div>
                           <div class="col-md-12 col-sm-12">
                              <div class="wp_csv_ftp form-group" style="margin: 0 -8px 0 -10px;">
                                 <label><?php echo esc_html__('Host Path','wp-advanced-importer');?></label>
                                 <input type="text" name="host_path" id="host_path" class="align form-control textbox_size" value="" placeholder = "">
                                 <p class="hint_fonts" ><?php echo esc_html__('/home/guest/sample.csv','wp-advanced-importer');?></p>
                              </div>
                           </div>
                           <div class="col-md-offset-10 mb10">
                              <input type="button" name="dwn_ftp_file" id="dwn_ftp_file" class="smack-btn smack-btn-primary btn-radius continue-btn" value="<?php echo esc_attr__('Continue','wp-advanced-importer');?>">
                           </div>
                        </div>
                        <!-- Tab 2 Content End-->
                     </div>
                     <div class="bhoechie-tab-content" id="division3">
                        ...
                        <div class="" style="margin-top: 100px;">
                           <label class="text-left"><?php echo __('File path','wp-advanced-importer');?></label>
                           ...
                           <input type="button" name="dwn_file" id="dwn_file" class="smack-btn smack-btn-primary btn-radius continue-btn" value="<?php echo esc_attr__('Continue','wp-advanced-importer');?>" onclick="external_method()"></div></div>
