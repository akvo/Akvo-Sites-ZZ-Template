...
if($_POST) {
	...
	$get_records = $xml_uci_admin->GetPostValues(sanitize_key($_REQUEST['eventkey']));
...
$actionURL = esc_url(admin_url() . 'admin.php?page=smack-uci-import&step=confirm&eventkey='.$_REQUEST['eventkey']);
...
<div class="template_body whole_body wp_ultimate_csv_importer_pro" style="font-size: 14px; margin-top: 40px;">
	...
	<div class="clearfix"></div>	<div class="col-md-12 mt40">	
		...
		<div class="pull-left">
		<a class="smack-btn btn-default btn-radius" href="<?php echo $backlink;?>"><?php echo esc_html__('Back','wp-advanced-importer');?>
                        </a></div>
