            ...
            <fieldset class="scheduler-border"> <legend class="scheduler-border" style="margin-top:15px;"><?php echo esc_html__('Contact Support','wp-advanced-importer');?></legend>
                <form class="support-form" type="post" action="" style="margin-top:10px;">
                    ...
                    <div id="loading" style="opacity:0.7;background-color: #fff;z-index: 99;text-align: center;">
                        <img class="col-md-offset-10 col-sm-offset-9 col-xs-offset-4 mb10" id="loading-image" src="<?php echo plugins_url().'/'.XML_SM_UCI_SLUG ;?>/assets/images/loading.gif" width="24" height="24" alt="Loading" style="display: none;margin-left: 110px;position: absolute;margin-top: 14px;" />
                    </div>

                    <div class="col-md-offset-10 col-sm-offset-9 col-xs-offset-4 mb10">
                        <input name="" id="" class="smack-btn smack-btn-primary btn-radius" value=<?php echo esc_attr__("Send","wp-advanced-importer");?> onclick="send_support_email();" type="button" style="margin-top:5px;">
                    </div>
                </form>
            </fieldset>
        </div>
        <div class="col-md-6 col-sm-6 mt40 mb40">
            <fieldset class="scheduler-border"> <legend class="scheduler-border" style="margin-top:20px;"><?php echo esc_html__('News Letter Subscription','wp-advanced-importer');?></legend>
                <div class="form-group">
                    <label><?php echo esc_html__('Email','wp-advanced-importer');?></label>
                    <input name="subscribe_email" id="subscribe_email" class="form-control" value="" type="text">
                </div>
                <div id="loading" style="opacity:0.7;background-color: #fff;z-index: 99;text-align: center;">
                    <img class="col-md-offset-10 col-sm-offset-9 col-xs-offset-4 mb10" id="loading-img-subs" src="<?php echo plugins_url().'/'.XML_SM_UCI_SLUG ;?>/assets/images/loading.gif" width="24" height="24" alt="Loading" style="display: none;margin-left: 65px;position: absolute;margin-top: 9px;" />
                </div>

                <div class="col-md-12">
                    <div class="col-md-offset-9 col-sm-offset-7 col-xs-offset-2 mb10">
                        <input name="" id="" class="smack-btn smack-btn-primary btn-radius" value=<?php echo esc_attr__("Subscribe","wp-advanced-importer");?>  onclick="send_subscribe_email();" type="button">
                    </div>
                </div>
            </fieldset>
        </div>
