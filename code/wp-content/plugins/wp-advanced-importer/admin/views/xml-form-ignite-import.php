...
$get_screen_info =  $xml_uci_admin->GetPostValues(sanitize_key($_REQUEST['eventkey']));
...
$gif = plugins_url('wp-advanced-importer/assets/images/ajax-loader.gif'); 
?>
...
<div class="col-md-12 mt40" style="text-align: center;">
	...
	<div class="event-summary">
		<span class="es-left"> <?php echo esc_html__('File Name:','wp-advanced-importer');?> <?php echo $get_screen_info[$eventkey]['import_file']['uploaded_name']; ?> </span>
		<span class="es-right"> <?php echo esc_html__('File Size:','wp-advanced-importer');?> <?php echo $xml_uci_admin->getFileSize($file); ?> </span>
	</div>
	<div class="event-summary">
		<span class="es-left"> <?php echo esc_html__('Process:','wp-advanced-importer');?> <?php echo $process_of_event; ?> </span>
		<span class="es-right"> <?php echo esc_html__('Total no of records:','wp-advanced-importer');?> <?php echo $total_row_count; ?> </span>
	</div>
...
<div class="col-md-12 mb30" id="dwnld_log_link" style="padding: 0px 40px 0px 40px;display: none;">
	<div class="pull-right"  >
                ...
                <a href="<?php echo $logfilename; ?>" download id="dwnldlog" style="font-size:15px;"> <?php echo esc_html_e("CLICK HERE TO DOWNLOAD LOG","wp-advanced-importer"); ?></a>
                   <?php } ?>
        </div>
