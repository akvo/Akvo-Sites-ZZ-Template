                ...
                <div class="panel-body no-padding">
                    <div style="height:300px;" class="col-md-3 setting-manager-list no-padding" id="left_sidebar">
                        <ul id="example">
                            ...
                            <!-- <li id='4'  class="bg-leftside" onclick="settings_div_selection(this.id);">
                                ...
                                <span><?php //echo esc_html__('Documentation','wp-advanced-importer');?></span>
                            </li> -->
                        </ul>
                    </div>
                    <div  class="col-md-9" id="rightside_content">
                        <div id="division1">
                            ...
                            <h3 class="csv-importer-heading"><?php echo esc_html_e('General Settings','wp-advanced-importer'); ?></h3>
                            <div class="col-md-11 col-md-offset-1 mt20 mb40">
                                ...
                                <!-- <div class="form-group mt20">
                                    <div class="col-xs-12 col-sm-8 col-md-8  nopadding">
                                        <h4><?php //echo esc_html_e('Scheduled log mails','wp-advanced-importer'); ?></h4>
                                        <p><?php //echo esc_html_e('Enable to get scheduled log mails.','wp-advanced-importer'); ?></p>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-3">
                                        <div class="mt20">
                                ...
                                <!-- <div class="form-group mt20">
                                    <div class="col-xs-12 col-sm-8 col-md-8  nopadding">
                                        <h4><?php //echo esc_html_e('Maintenance mode','wp-advanced-importer'); ?></h4>
                                        <p><?php //echo esc_html_e('Enable to maintain your Wordpress site.','wp-advanced-importer'); ?></p>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-3">
                                        <div class="mt20">
                                ...
                                <div class="form-group mt20">
                                    <div class="col-xs-12 col-sm-8 col-md-8  nopadding">
                                        <h4><?php //echo esc_html_e('Roll back mode','wp-advanced-importer'); ?></h4>
                                        <p><?php //echo esc_html_e('Enable to Roll back the database again.','wp-advanced-importer'); ?></p>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-3">
                                        <div class="mt20">
                                ...
                                <div class="form-group mt20">
                                    <div class="col-xs-12 col-sm-8 col-md-8  nopadding">
                                        <h4 ><?php //echo esc_html_e('CMB2 Meta Fields prefix','wp-advanced-importer'); ?></h4>
                                        <p><?php //echo esc_html_e('Mention the prefix of your fields.','wp-advanced-importer'); ?></p>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-3 mb20">
                                        <div class="mt20">
				     ...
				     <?php if(defined('DISABLE_WP_CRON') && DISABLE_WP_CRON == true) { ?>    
                        ...
                        <div id="division4" style="display:none;">
                            ...
                            <div id ='divdata'>
                                ...
                                <div id="relatedpages">
                                    <h2 id="doctitle"><?php echo esc_html_e('Smackcoders Guidelines','wp-advanced-importer'); ?> </h2 >
                                    <p> <a href=" https://goo.gl/OAVF9u" target="_blank"> <?php echo __('Development News','wp-advanced-importer'); ?> </a> </p>
                                    <p> <a href=" https://goo.gl/kKWPui" target="_blank"><?php echo __('Whats New?','wp-advanced-importer'); ?> </a> </p>
                                    <p> <a href="https://goo.gl/hyU5G1" target="_blank"><?php echo __(' Documentation','wp-advanced-importer'); ?> </a> </p>
                                    <p> <a href="https://goo.gl/OgW9PJ" target="_blank"> <?php echo __('Youtube Channel','wp-advanced-importer'); ?> </a> </p>
                                    <p> <a href="https://goo.gl/smw3WV" target="_blank"><?php echo __(' Other WordPress Plugins','wp-advanced-importer'); ?> </a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
