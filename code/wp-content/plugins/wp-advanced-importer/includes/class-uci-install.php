...
class WpXMLSmackUCIInstall {
	...
	public static function install_actions() {
		if ( ! empty( $_GET['do_update_XML_SM_UCI_pro'] ) ) {
			self::update();
		}
	}
	...
	public static function important_cron_notice() {
		...
		if($get_notice != 'off' && isset($_REQUEST['page']) && $_REQUEST['page'] == 'smack-uci-import') {
			?>
			...
			<?php
			if(function_exists( 'curl_version' ) == null || function_exists( 'curl_version' ) == '' && isset($_REQUEST['page']) && $_REQUEST['page'] == 'smack-uci-import') { ?>
