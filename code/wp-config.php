...
define('DB_NAME', 'akvosites');

/** MySQL database username */
define('DB_USER', 'akvosites');

/** MySQL database password */
define('DB_PASSWORD', 'GwxrjW1Deq5dK1Za2irUz0pqfE0azVPUGxw5NFu3');

/** MySQL hostname */
define('DB_HOST', 'mysql.test.akvo-ops.org');
...
//define('DOMAIN_CURRENT_SITE', 'akvofoundation.org');
